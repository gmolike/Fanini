 ...
 */
export const ContactCard = ({ member, canViewSensitiveData }: MemberContactCardProps) => {
  return (
    <Card>
      <CardHeader>
        ...
        <DataGrid columns={1}>
          ...
          {member.telefon ? (
            <DataField
              ...
              value={
                <div className="flex items-center gap-2">
                  <PhoneDisplay phone={member.telefon} />{' '}
                  {member.sichtbarkeit?.telefon ? (
                    <EnumBadge
          ...
          {canViewSensitiveData && member.adresse ? (
            <DataField
              label="Adresse"
              value={
                <div>
          ...
          {canViewSensitiveData && member.notfallkontakt ? (
            <DataField
