...
import { Palette, Settings, Shield,ToggleLeft } from 'lucide-react';
...
// Extracted StatsGrid component to reduce cognitive complexity
type Settings = {
  branding: {
    colors: {
      primary: string;
...
function StatsGrid({ settings }: Readonly<{ settings: Settings | undefined }>) {
  const stats = [
    {
      title: 'Primärfarbe',
    ...
    },
    {
      ...
      desc: `von ${(settings ? Object.keys(settings.features).length : 3).toString()} verfügbar`,
      icon: ToggleLeft,
