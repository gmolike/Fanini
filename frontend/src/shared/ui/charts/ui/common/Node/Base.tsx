 ...
 */
export const BaseNode = memo<NodeProps<BaseNodeData>>(
    ...
    return (
      <button
        ...
        className={cn(
          ...
          selected === true ? 'border-primary scale-105 shadow-lg' : '',
          selected === false ? 'border-border hover:border-muted-foreground' : '',
          dragging === true ? 'cursor-grabbing opacity-50' : ''
        )}
