  ...
  return (
    <FormFieldWrapper
      ...
      render={field => {
        ...
        let additionalContentNode = null;
        if (additionalContent !== undefined && additionalContent !== null) {
          if (typeof additionalContent === 'function') {
            additionalContentNode = additionalContent(field.value);
          } else {
            additionalContentNode = additionalContent;
          }
        }
          ...
          <>
            <div className="space-y-1">
              ...
              >
                ...
                {/* Right Icon */}
                {EndIcon ? <EndIcon className="ml-2 h-4 w-4 shrink-0 opacity-50" /> : null}
              </Button>
