// packages/shared/scripts/generate-types-direct.ts
...
const generateTypes = () => {
  const types = `// Auto-generated types from backend
// DO NOT EDIT MANUALLY

// ========== ENUMS ==========
export type RoleName = 'ADMIN' | 'VORSTAND' | 'BEIRAT' | 'KASSENPRUFER' | 'TEAM_EVENT' | 'TEAM_MEDIEN' | 'TEAM_TECHNIK' | 'TEAM_VEREIN' | 'MITGLIED';

export type EventType = 'vereinstreffen' | 'sportveranstaltung' | 'fanfahrt' | 'social' | 'sitzung' | 'workshop' | 'turnier' | 'sonstiges';

export type EventStatus = 'entwurf' | 'geplant' | 'genehmigt' | 'aktiv' | 'abgeschlossen' | 'abgesagt';

export type SportBereich = 'league_of_legends' | 'fussball' | 'esports_allgemein' | 'sonstiges';
